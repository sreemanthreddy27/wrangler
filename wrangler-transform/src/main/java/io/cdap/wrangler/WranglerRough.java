...
//public class WranglerRough extends Transform<StructuredRecord, StructuredRecord>
...
//    static final String NAME_NON_NULLABLE_COLUMNS = "nonNullableColumns";
//    static final String NAME_USER_DEFINED_ACTION = "userDefinedAction";
...
//
//    @Name(NAME_NON_NULLABLE_COLUMNS)
//    @Description("contains the list of non- nullable columns")
//    @Macro
//    @Nullable
//    private final String nonNullableColumns;
//
//    @Name(NAME_USER_DEFINED_ACTION)
//    @Description("contains the user defined action to be performed for Null Handling")
//    @Macro
//    @Nullable
//    private final String userDefinedAction;
//
...
//        String userDefinedAction, String columnMappings, @Nullable String bigtableOptions) {
...
//    }
//
//    public String getUserDefinedAction() {
...
//            String.format(
//                "Please set a value with a Macro referencing an existing connection
//                for property %s.", NAME_CONNECTION)
